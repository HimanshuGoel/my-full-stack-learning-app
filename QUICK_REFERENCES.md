...
>quick references - console commands
...
:[copilot]modernazie this method
...
:[copilot]optimize performnace, avoiding unnecesssary memory allocation, minimzing netwrok calls, optimizing database access, applying best practices
...
>quick references - keyboard shortcuts
:[idea]optimise imports - alt + shift + o
